...
class StableCircuitBackend(cirq.Sampler):
    def __init__(self,
    ...
    def convert_and_run(self, circuit: cirq.Circuit,
        ...
        measurements['out'].extend(shots)
        measurements['out'] = np.array(measurements['out'], dtype=np.uint8)
        return measurements


if __name__ == '__main__':
     to_qc = StableCircuitBackend('ibmq_essex')
